...
class CloudUpdate extends Cloud
{
    ...
    {
        throw new CloudException('Cloud update is disabled for security reasons.');
    ...
    {
        throw new CloudException('Cloud update SQL execution is disabled for security reasons.');
