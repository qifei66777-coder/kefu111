...
{   
	...
	popupDivHtml = '<div id="kfpopupDiv" onmousedown="MyMove.Move(\'kfpopupDiv\',event,1);"  style="-moz-user-select:none; -webkit-user-select:none; user-select:none; z-index:999999;filter:alpha(opacity=90); position: absolute; top: 400px; left: 50%; margin-left:-170px; color:#000;font-size: 12px;cursor:move;height: 150px;width: 340px;">';
