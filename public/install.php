...
exit('Installer is disabled. Remove this file from production deployments.');
        ...
        <?php if (!@$step): ?>
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <?php
                    if (PHP_VERSION >= '7.2.3' && PHP_VERSION < '7.4') {
                        ?>
...
<footer class="footer">
    <div class="container">
        <p class="text-muted">Powered by AnniePHP在线客服系统</p>
    </div>
</footer>
<!-- javascript -->
